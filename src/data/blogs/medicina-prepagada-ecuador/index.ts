...
import postEcuadorPrepagada from '../../../assets/images/post_ecuador_prepagada_1780025031230.webp';
...
export const post: BlogPost = {
  ...
  content: [
    ...
    '3. **Límites de Cobertura y Preexistencias:** Al afilizarte o cambiar de seguro en el Ecuador, debes reportar tu historial médico de manera transparente. El factor clave es que el plan incluya un alto límite de cobertura económica para hospitalización, cirugías complejas y maternidad.',
