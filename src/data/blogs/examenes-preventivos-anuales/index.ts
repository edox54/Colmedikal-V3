...
export const post: BlogPost = {
  ...
  content: [
    ...
    'Uno de los mayores obstáculos para cumplir con estos chequeos anuales en el sistema tradicional del IESS es la burocracia para conseguir órdenes médicas y [agendar citas de especialidad](/agendamiento). Con planes de medicina prepagada como los de Colmedikal, accedes directamente a laboratorios clínicos premium del país y a los [médicos especialistas en prevención familiar](/directorio) de manera rápida, cómoda, sin autorizaciones demoradas y bajo un acompañamiento de primer orden. También puedes conocer en detalle todos nuestros [servicios de salud disponibles](/servicios).',
    'También te puede interesar: [Guía completa de medicina prepagada en Ecuador](/blog/medicina-prepagada-ecuador) · [Atención materna y familiar: beneficios de cobertura de alta complejidad](/blog/cobertura-salud-familiar-maternidad).'
  ]
};
