...
export const post: BlogPost = {
  ...
  content: [
    ...
    'Si estás planeando tener hijos en los próximos 12 a 24 meses, la recomendación médica número uno es cotizar tu plan con anterioridad. La mayoría de seguros médicos privados de primer nivel exigen un período de carencia para la cobertura del parto (habitualmente que la concepción se dé después de la afiliación o de un tiempo estipulado). Utiliza el [Cotizador Online Colmedikal](/cotizador) hoy mismo, ingresando los datos de tu pareja, para estructurar el plan de maternidad perfecto con tarifas altamente competitivas. Si tienes dudas, puedes [agendar una asesoría gratuita](/agendamiento) o consultar nuestro [directorio de ginecobstetras](/directorio).',
    'También te puede interesar: [Guía completa de medicina prepagada en Ecuador](/blog/medicina-prepagada-ecuador) · [5 exámenes preventivos anuales indispensables](/blog/examenes-preventivos-anuales).'
  ]
};
