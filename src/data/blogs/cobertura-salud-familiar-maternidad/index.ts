...
export const post: BlogPost = {
  ...
  content: [
    ...
    'Si estás planeando tener hijos en los próximos 12 a 24 meses, la recomendación médica número uno es cotizar tu plan con anterioridad. La mayoría de seguros médicos privados de primer nivel exigen un período de carencia para la cobertura del parto (habitualmente que la concepción se dé después de la afiliación o de un tiempo estipulado). Utiliza el **Cotizador Online Colmedikal** hoy mismo, ingresando los datos de tu pareja, para de inmediato estructurar el plan de maternidad perfecto con tarifas altamente competitivas.'
  ]
};
